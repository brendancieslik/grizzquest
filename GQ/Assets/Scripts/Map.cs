...
namespace SophProj
{
    ...
    class Map
    {
        ...
        public void CreateMap()
        {
            ...
            //Creates mapSize number of tiers. 
        ...
        private List<MapNode> CreateTier(int tier, System.Random r)
        {
            int nodeCount = r.Next(1, 5);
            List <MapNode> currTier = new List<MapNode>();
            for (int i = 0; i < nodeCount; i++)
            {
                MapNode n = new MapNode(tier);
                currTier.Add(n);
                nodes.Add(n);
            }
            return currTier;
        ...
        private void CreateTierEdges(List<MapNode> prev, List<MapNode> curr)
        {
